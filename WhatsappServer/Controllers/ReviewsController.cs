...
namespace WhatsappServer.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Date,Score,Feedback")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Date,Score,Feedback")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
